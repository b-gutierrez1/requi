    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="form-container">
                ...
                <form action="<?= url('/admin/autorizadores/respaldos/' . View::e($respaldo['id'] ?? '')) ?>" method="POST" id="respaldoForm">
...
<form id="deleteForm" action="<?= url('/admin/autorizadores/respaldos/' . View::e($respaldo['id'] ?? '')) ?>" method="POST" style="display: none;">

...
<div class="container">
    ...
    <nav aria-label="Paginación de autorizadores" class="mt-4">
        <ul class="pagination justify-content-center">
            <?php
            $currentPage = $page ?? 1;
            $lastPage    = $totalPages ?? 1;
            // Preservar parámetros GET existentes excepto 'page'
            $queryParams = $_GET;
            ...
            <li class="page-item <?= $currentPage <= 1 ? 'disabled' : '' ?>">
                <a class="page-link" href="<?= url('/admin/autorizadores?page=' . ($currentPage - 1) . $baseQuery) ?>" aria-label="Anterior">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>

            <!-- Páginas numeradas (máximo 5 alrededor de la actual) -->
            <?php
            $startPage = max(1, $currentPage - 2);
            $endPage   = min($lastPage, $currentPage + 2);
            if ($startPage > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="<?= url('/admin/autorizadores?page=1' . $baseQuery) ?>">1</a>
                </li>
                <?php if ($startPage > 2): ?>
            ...
            <?php for ($p = $startPage; $p <= $endPage; $p++): ?>
                <li class="page-item <?= $p === $currentPage ? 'active' : '' ?>">
                    <a class="page-link" href="<?= url('/admin/autorizadores?page=' . $p . $baseQuery) ?>"><?= $p ?></a>
                </li>
            <?php endfor; ?>
            ...
            <?php if ($endPage < $lastPage): ?>
                ...
                <?php endif; ?>
                <li class="page-item">
                    <a class="page-link" href="<?= url('/admin/autorizadores?page=' . $lastPage . $baseQuery) ?>"><?= $lastPage ?></a>
                </li>
            <?php endif; ?>

            <!-- Siguiente -->
            <li class="page-item <?= $currentPage >= $lastPage ? 'disabled' : '' ?>">
                <a class="page-link" href="<?= url('/admin/autorizadores?page=' . ($currentPage + 1) . $baseQuery) ?>" aria-label="Siguiente">
...
<script src="<?php echo \App\Helpers\View::asset('js/admin/autorizadores-index.js'); ?>"></script>
<?php View::endSection(); ?>

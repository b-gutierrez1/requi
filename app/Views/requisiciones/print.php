...
<div class="page">
    ...
    <table style="width:100%; border-collapse:collapse;">
        <tr>
            <td style="border:none; padding:0; width:100%">
                <table class="data-table" style="width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?= $d ? View::e($d['cuenta_nombre'] ?? '') : '' ?></td>
                            ...
                            <td class="text-center"><?= $d ? View::e($d['cuenta_contable_codigo'] ?? '') : '' ?></td>
                        </tr>
                        <?php endfor; ?>
                        <tr class="total-row">
            ...
            <!-- Botones Ingreso (decorativos) -->
            <td style="border:none; padding:0 0 0 2px; vertical-align:top; width:20px">
                <div class="ingreso-btn">Ingreso</div>
                <div class="ingreso-btn">Ingreso</div>
                <div class="ingreso-btn">Ingreso</div>
            </td>
        </tr>
